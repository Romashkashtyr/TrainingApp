...
sealed class DashboardViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    inner class StepsViewHolder(private val binding: ItemStepsBinding) : DashboardViewHolder(binding.root) {
    ...
    inner class WorkoutsViewHolder(private val binding: ItemWorkoutBinding) : DashboardViewHolder(binding.root){
